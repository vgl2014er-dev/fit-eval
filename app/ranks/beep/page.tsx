    ...
    <main className="min-h-[100dvh] flex flex-col font-mono uppercase bg-ink text-white">
      ...
      <header className="border-b border-white/20 p-4 flex justify-between items-center text-xs sm:text-sm tracking-widest bg-ink sticky top-0 z-50">
        <div className="flex items-center gap-6">
          ...
          <Link href="/ranks/beep/edit" className="flex items-center gap-2 text-white/50 hover:text-volt transition-colors">
            <Edit2 size={14} />
            EDIT RANKS
          </Link>
        </div>
        <div className="text-white/50 hidden sm:block">SYS.FITNESS.LEADERBOARD // BEEP TEST</div>
      </header>
      ...
      <div className="p-4 sm:p-10 max-w-5xl mx-auto w-full">
        ...
        {loading ? (
          <div className="flex justify-center py-20">
            <Loader2 className="animate-spin text-volt" size={48} />
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-[10px] sm:text-xs opacity-60 mb-1">STAGE</div>
